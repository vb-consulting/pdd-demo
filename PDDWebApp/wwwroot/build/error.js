var error = (function () {
    ...
    */
    ...
    function create_if_block_3(ctx) {
    	...
    	let if_block1 = /*titleCloseButton*/ ctx[5] && create_if_block_4(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$3, 135, 12, 3755);
    			attr_dev(div, "class", "offcanvas-header");
    			add_location(div, file$3, 134, 8, 3711);
    		},
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 142, 12, 3983);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	let t1;
    	let current;
    	let if_block0 = /*promise*/ ctx[6] && create_if_block_2$1(ctx);
    	let if_block1 = /*content*/ ctx[7] && create_if_block_1$1(ctx);
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$3, 151, 24, 4302);
    			attr_dev(div, "class", "text-center");
    			add_location(div, file$3, 150, 20, 4251);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, i);
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = (/*title*/ ctx[4] || /*titleCloseButton*/ ctx[5] || /*$$slots*/ ctx[10].title) && create_if_block_3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 146, 4, 4112);
    			...
    			add_location(div1, file$3, 132, 0, 3493);
    		},
    ...
    const getFromJson = (id) => JSON.parse(get(id));
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 4, 4, 93);
    			attr_dev(li, "class", "nav-item py-0");
    			add_location(li, file$2, 3, 0, 61);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	let offcanvas_1;
    	let current;
    	let if_block = !/*offcanvas*/ ctx[2].open && create_if_block_2(ctx);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 84, 25, 2353);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 86, 8, 2606);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4");
    			add_location(ul, file$1, 87, 8, 2747);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			insert_dev(target, t, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(pre, file$1, 106, 20, 3438);
    			attr_dev(i, "class", "bi bi-box-arrow-right");
    			add_location(i, file$1, 110, 24, 3645);
    			attr_dev(a, "class", "btn btn-sm btn-primary");
    			attr_dev(a, "href", urls.logoutUrl);
    			add_location(a, file$1, 109, 20, 3561);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = !/*pinned*/ ctx[1] && create_if_block_1(ctx);

    	function select_block_type(ctx, dirty) {
    		if (/*user*/ ctx[4].isSigned) return create_if_block$1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$1, 99, 20, 3157);
    			attr_dev(span, "class", "font-monospace");
    			add_location(span, file$1, 100, 20, 3243);
    			attr_dev(button0, "class", "btn btn-primary");
    			add_location(button0, file$1, 98, 16, 3068);
    			attr_dev(div0, "class", "d-flex float-start");
    			add_location(div0, file$1, 97, 12, 3018);

    			attr_dev(i1, "class", i1_class_value = /*$isDarkTheme*/ ctx[3]
    			? "bi-lightbulb"
    			: "bi-lightbulb-off");

    			add_location(i1, file$1, 120, 20, 4182);
    ...
    /* App\error.svelte generated by Svelte v3.49.0 */

    const { Error: Error_1 } = globals;
    const file = "App\\error.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p0 = element("p");
    			p0.textContent = "Here is what we know:";
    			t1 = space();
    			p1 = element("p");
    			t2 = text(/*error*/ ctx[0]);
    			attr_dev(p0, "id", "error-label");
    			add_location(p0, file, 17, 8, 484);
    			attr_dev(p1, "class", "text-danger");
    			add_location(p1, file, 20, 8, 563);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			h2 = element("h2");
    			h2.textContent = "An error occurred while processing your request.";
    			t3 = space();
    			if (if_block) if_block.c();
    			attr_dev(h1, "class", "text-danger");
    			add_location(h1, file, 14, 8, 331);
    			attr_dev(h2, "class", "text-danger");
    			add_location(h2, file, 15, 8, 376);
    			attr_dev(div, "class", "container");
    			add_location(div, file, 13, 4, 298);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h1);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout, get, error, key });
    ...
    var Error_entry = new Error$1({ target: document.body });
