var notfound = (function () {
    ...
    */
    ...
    /* App\404.svelte generated by Svelte v3.49.0 */
    const file = "App\\404.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			p.textContent = "This page doesn't seem to exists.";
    			attr_dev(h1, "class", "text-danger");
    			add_location(h1, file, 5, 8, 137);
    			add_location(p, file, 7, 8, 199);
    			attr_dev(div, "class", "container text-center");
    			add_location(div, file, 4, 4, 92);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h1);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout });
    	return [];
    }
    ...
    var NotFound_entry = new _404({ target: document.body });
