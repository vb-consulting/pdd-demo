var unauthorized = (function () {
    ...
    */
    ...
    function create_fragment$3(ctx) {
    	...
    	let if_block1 = /*state*/ ctx[0].open && create_if_block$1(ctx);
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*user*/ ctx[4].isSigned) return create_if_block;
    ...
    /* App\401.svelte generated by Svelte v3.49.0 */
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "401 Unathorized Access";
    			t1 = space();
    			p = element("p");
    			t2 = text("You might want to login by using the ");
    			a = element("a");
    			t3 = text("Login");
    			t4 = text(" page.");
    			attr_dev(h1, "class", "text-danger");
    			add_location(h1, file, 6, 8, 172);
    			attr_dev(a, "class", "btn btn-outline-secondary btn-sm");
    			attr_dev(a, "href", urls.loginUrl);
    			add_location(a, file, 9, 49, 297);
    			add_location(p, file, 8, 8, 243);
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('_401', slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<_401> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout, urls });
    	return [];
    }

    class _401 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    var Unauthorized_entry = new _401({ target: document.body });
