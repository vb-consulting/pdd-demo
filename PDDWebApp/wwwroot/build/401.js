var unauthorized = (function () {
    ...
    */
    ...
    function create_if_block_2(ctx) {
    	...
    	let offcanvas_1;
    	let current;
    	let if_block = !/*offcanvas*/ ctx[2].open && create_if_block_3(ctx);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if (default_slot) default_slot.c();
    			attr_dev(button, "class", "btn btn-sm btn-primary pin bi-pin svelte-1y9e2j");
    			attr_dev(button, "data-bs-toggle", "tooltip");
    			attr_dev(button, "title", "Unpin sidebar");
    			add_location(button, file$1, 134, 8, 4494);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4");
    			add_location(ul, file$1, 135, 8, 4631);
    			attr_dev(div, "class", "offcanvas-nav navbar-dark bg-primary svelte-1y9e2j");
    			add_location(div, file$1, 133, 4, 4434);
    			attr_dev(main, "class", "pinned-layout svelte-1y9e2j");
    			add_location(main, file$1, 132, 0, 4400);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if (default_slot) default_slot.c();
    			add_location(main, file$1, 128, 0, 4355);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = !/*pinned*/ ctx[1] && create_if_block_2(ctx);

    	function select_block_type(ctx, dirty) {
    		if (/*user*/ ctx[4].isSigned) return create_if_block_1;
