var index = (function () {
    ...
    */
    ...
    /* App\shared\components\offcanvas.svelte generated by Svelte v3.49.0 */
    ...
    const getFromJson = (id) => JSON.parse(get$1(id));

    const urls = getFromJson("urls");

    /* App\shared\layout\link-list-items.svelte generated by Svelte v3.49.0 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$5, 4, 4, 93);
    			attr_dev(li, "class", "nav-item py-0");
    			add_location(li, file$5, 3, 0, 61);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    var _a;
    const key = get$1("theme-key");
    const link = document.head.querySelector(`#${key}`);
    ...
    /* App\shared\layout\offcanvas-layout.svelte generated by Svelte v3.49.0 */
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "gutter svelte-1y9e2j");
    			add_location(div, file$4, 84, 25, 2353);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div, "mouseover", /*gutterMouseover*/ ctx[7], false, false, false),
    ...
    // (86:4) <Offcanvas state={offcanvas} classes="offcanvas-nav navbar-dark bg-primary" on:hidden={() => toggleOffcanvas(false)} use={useOffcanvas}>
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "btn btn-sm btn-primary pin bi-pin-angle svelte-1y9e2j");
    			attr_dev(button, "data-bs-toggle", "tooltip");
    			attr_dev(button, "title", "Pin sidebar");
    			add_location(button, file$4, 86, 8, 2606);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4");
    			add_location(ul, file$4, 87, 8, 2747);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			insert_dev(target, t, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*togglePin*/ ctx[9], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop$1,
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(86:4) <Offcanvas state={offcanvas} classes=\\\"offcanvas-nav navbar-dark bg-primary\\\" on:hidden={() => toggleOffcanvas(false)} use={useOffcanvas}>",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			pre.textContent = `                        ${/*user*/ ctx[4].email}
                    `;
    			...
    			i = element("i");
    			t4 = text("\r\n                        Logout");
    			attr_dev(pre, "class", "user-info text-nowrap");
    			add_location(pre, file$4, 106, 20, 3438);
    			attr_dev(i, "class", "bi bi-box-arrow-right");
    			add_location(i, file$4, 110, 24, 3645);
    			attr_dev(a, "class", "btn btn-sm btn-primary");
    			attr_dev(a, "href", urls.logoutUrl);
    			add_location(a, file$4, 109, 20, 3561);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$4, 99, 20, 3157);
    			attr_dev(span, "class", "font-monospace");
    			add_location(span, file$4, 100, 20, 3243);
    			attr_dev(button0, "class", "btn btn-primary");
    			add_location(button0, file$4, 98, 16, 3068);
    			attr_dev(div0, "class", "d-flex float-start");
    			add_location(div0, file$4, 97, 12, 3018);

    			attr_dev(i1, "class", i1_class_value = /*$isDarkTheme*/ ctx[3]
    			? "bi-lightbulb"
    			: "bi-lightbulb-off");

    			add_location(i1, file$4, 120, 20, 4182);
    			...
    			add_location(button1, file$4, 119, 16, 3993);
    			attr_dev(div1, "class", "d-flex float-end");
    			add_location(div1, file$4, 104, 12, 3349);
    			attr_dev(div2, "class", "container-fluid");
    			add_location(div2, file$4, 95, 8, 2973);
    			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark fixed-top bg-primary py-0 py-md-0");
    			add_location(nav, file$4, 94, 4, 2880);
    			attr_dev(header, "class", "svelte-1y9e2j");
    			add_location(header, file$4, 93, 0, 2866);
    			attr_dev(button2, "class", "btn btn-sm btn-primary pin bi-pin svelte-1y9e2j");
    			attr_dev(button2, "data-bs-toggle", "tooltip");
    			attr_dev(button2, "title", "Unpin sidebar");
    			add_location(button2, file$4, 130, 8, 4466);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4");
    			add_location(ul, file$4, 131, 8, 4603);
    			attr_dev(div3, "class", "offcanvas-nav navbar-dark bg-primary svelte-1y9e2j");
    			toggle_class(div3, "d-none", !/*pinned*/ ctx[1]);
    			add_location(div3, file$4, 129, 4, 4383);
    			attr_dev(main, "class", "svelte-1y9e2j");
    			toggle_class(main, "pinned-layout", /*pinned*/ ctx[1]);
    			add_location(main, file$4, 128, 0, 4342);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(document_1.body, "mouseover", /*bodyMouseover*/ ctx[8], false, false, false),
    					...
    					listen_dev(button2, "click", /*togglePin*/ ctx[9], false, false, false)
    				];
    ...
    /* App\shared\components\modal.svelte generated by Svelte v3.49.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*classes, scrollable*/ 2080) {
    				toggle_class(div2, "modal-dialog-scrollable", /*scrollable*/ ctx[5]);
    			}

    			if (dirty[0] & /*classes, fullscreen*/ 2176) {
    				toggle_class(div2, "modal-fullscreen", /*fullscreen*/ ctx[7]);
    			}

    			if (dirty[0] & /*classes, centered*/ 2112) {
    				toggle_class(div2, "modal-dialog-centered", /*centered*/ ctx[6]);
    			}

    			if (dirty[0] & /*classes, small*/ 3072) {
    				toggle_class(div2, "modal-sm", /*small*/ ctx[10]);
    			}

    			if (dirty[0] & /*classes, large*/ 2304) {
    				toggle_class(div2, "modal-lg", /*large*/ ctx[8]);
    			}

    			if (dirty[0] & /*classes, extraLarge*/ 2560) {
    				toggle_class(div2, "modal-xl", /*extraLarge*/ ctx[9]);
    			}
    ...
    const _parseQuery = (query) => Object.keys(query).map(key => `${key}=${encodeURIComponent(query[key])}`).join('&');
    const _parseUrl = (url, query = null) => query ? `${url}?${_parseQuery(query)}` : url;
    const get = async (url, query = null) => _fetch(_parseUrl(url, query), "GET", "json");
    ...
    class Chart_box extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*getUrl*/ ctx[2] === undefined && !('getUrl' in props)) {
    			console.warn("<Chart_box> was created without expected prop 'getUrl'");
    		}
    	}
    ...
    /* App\index.svelte generated by Svelte v3.49.0 */
    const file = "App\\index.svelte";

    // (6:0) <Layout title="PDD Dashboard">
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div7 = element("div");
    			div4 = element("div");
    			create_component(chartbox3.$$.fragment);
    			t3 = space();
    			div5 = element("div");
    			create_component(chartbox4.$$.fragment);
    			t4 = space();
    			div6 = element("div");
    			create_component(chartbox5.$$.fragment);
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(chartbox3, div4, null);
    			append_dev(div7, t3);
    			append_dev(div7, div5);
    			mount_component(chartbox4, div5, null);
    			append_dev(div7, t4);
    			append_dev(div7, div6);
    			mount_component(chartbox5, div6, null);
    			current = true;
    		},
    		p: noop$1,
    		i: function intro(local) {
    			...
    			transition_in(chartbox3.$$.fragment, local);
    			transition_in(chartbox4.$$.fragment, local);
    			transition_in(chartbox5.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			...
    			transition_out(chartbox3.$$.fragment, local);
    			transition_out(chartbox4.$$.fragment, local);
    			transition_out(chartbox5.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(chartbox3);
    			destroy_component(chartbox4);
    			destroy_component(chartbox5);
    		}
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(6:0) <Layout title=\\\"PDD Dashboard\\\">",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout, ChartBox: Chart_box, urls });
    	return [];
    }
