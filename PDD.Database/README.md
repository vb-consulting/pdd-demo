...
- Local time stamp: `2022-10-17T13:02:52.6902644+02:00`
...
- Function [`dashboard.top_experinced_people(integer, out uuid, out character varying, out character varying, out integer, out character varying, out smallint, out integer, out bigint, out character varying, out varchar[])`](#function-dashboardtop_experinced_peopleinteger-out-uuid-out-character-varying-out-character-varying-out-integer-out-character-varying-out-smallint-out-integer-out-bigint-out-character-varying-out-varchar)
- Function [`dashboard.top_rated_companies(integer, out uuid, out character varying, out character varying, out character varying, out smallint, out varchar[], out numeric, out bigint)`](#function-dashboardtop_rated_companiesinteger-out-uuid-out-character-varying-out-character-varying-out-character-varying-out-smallint-out-varchar-out-numeric-out-bigint)
- Function [`companies.search_companies(character varying, integer, integer)`](#function-companiessearch_companiescharacter-varying-integer-integer)
...
### Function `dashboard.top_experinced_people(integer, out uuid, out character varying, out character varying, out integer, out character varying, out smallint, out integer, out bigint, out character varying, out varchar[])`
...
<!-- comment on function "dashboard"."top_experinced_people"(integer, out uuid, out character varying, out character varying, out integer, out character varying, out smallint, out integer, out bigint, out character varying, out varchar[]) is @until-end-tag; -->
Top experienced people by the years of the working experience.
<!-- end -->

<a href="#table-of-contents" title="Table of Contents">&#8673;</a>

### Function `dashboard.top_rated_companies(integer, out uuid, out character varying, out character varying, out character varying, out smallint, out varchar[], out numeric, out bigint)`
...
<!-- comment on function "dashboard"."top_rated_companies"(integer, out uuid, out character varying, out character varying, out character varying, out smallint, out varchar[], out numeric, out bigint) is @until-end-tag; -->
...
### Function `companies.search_companies(character varying, integer, integer)`
...
<!-- comment on function "companies"."search_companies"(character varying, integer, integer) is @until-end-tag; -->
<!-- end -->
...
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`6`** | count=**`3.023`** | inserted=**`13`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`52`** | rows=**`3.023`** | live=**`13`**, dead=**`0`** | last auto=, rows inserted since=**`13`** | last auto=, rows updated since=**`13`** |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`5`** | count=**`18`** | inserted=**`6`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`18`** | rows=**`18`** | live=**`6`**, dead=**`0`** | last auto=, rows inserted since=**`6`** | last auto=, rows updated since=**`6`** |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`6`** | count=**`127.964`** | inserted=**`18`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`54`** | rows=**`127.964`** | live=**`18`**, dead=**`0`** | last auto=, rows inserted since=**`18`** | last auto=, rows updated since=**`18`** |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`12`** | count=**`261.891`** | inserted=**`969`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`4.845`** | rows=**`260.924`** | live=**`969`**, dead=**`0`** | last auto=, rows inserted since=**`969`** | last auto=**`2022-10-17 11:02:31Z`**, rows updated since=**`0`** |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-company_areas-company_id" href="#public-company_areas-company_id">#</a>`company_id` | **FK [➝](#public-companies-id) `companies.id`**, **IDX** | `uuid`| **NO** |  | <!-- comment on column "public"."company_areas"."company_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-company_areas-company_id" href="#public-company_areas-company_id">#</a>**`company_id`** | **PK** | `uuid`| **NO** |  | <!-- comment on column "public"."company_areas"."company_id" is @until-end-tag; --><!-- end --> |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`8`** | count=**`3.046`** | inserted=**`3.023`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`9.069`** | rows=**`23`** | live=**`3.023`**, dead=**`0`** | last auto=**`2022-10-17 11:02:31Z`**, rows inserted since=**`0`** | last auto=**`2022-10-17 11:02:31Z`**, rows updated since=**`0`** |
...
| <a id="user-content-public-company_reviews-score" href="#public-company_reviews-score">#</a>`score` | `CHECK (review IS NOT NULL OR score IS NOT NULL)`, `CHECK (score IS NULL OR score > 0 AND score <= 5)` | `smallint`| YES |  | <!-- comment on column "public"."company_reviews"."score" is @until-end-tag; -->score 1-5<!-- end --> |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`10`** | count=**`0`** | inserted=**`137.636`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`412.908`** | rows=**`0`** | live=**`137.636`**, dead=**`0`** | last auto=**`2022-10-17 11:02:31Z`**, rows inserted since=**`0`** | last auto=**`2022-10-17 11:02:31Z`**, rows updated since=**`0`** |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`11`** | count=**`50.969`** | inserted=**`249`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`1.743`** | rows=**`50.969`** | live=**`249`**, dead=**`0`** | last auto=, rows inserted since=**`249`** | last auto=**`2022-10-17 11:02:31Z`**, rows updated since=**`0`** |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`10`** | count=**`0`** | inserted=**`120.232`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`360.696`** | rows=**`0`** | live=**`120.232`**, dead=**`0`** | last auto=**`2022-10-17 11:02:31Z`**, rows inserted since=**`0`** | last auto=**`2022-10-17 11:02:31Z`**, rows updated since=**`0`** |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`5`** | count=**`50.006`** | inserted=**`6`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`18`** | rows=**`50.006`** | live=**`6`**, dead=**`0`** | last auto=, rows inserted since=**`6`** | last auto=, rows updated since=**`6`** |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`16`** | count=**`435.814`** | inserted=**`50.000`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`250.000`** | rows=**`386.355`** | live=**`50.000`**, dead=**`0`** | last auto=**`2022-10-17 11:02:32Z`**, rows inserted since=**`0`** | last auto=**`2022-10-17 11:02:32Z`**, rows updated since=**`0`** |
...
| Column |             | Type | Nullable | Default | Comment |
| ------ | ----------- | -----| :------: | ------- | ------- |
| <a id="user-content-public-person_roles-person_id" href="#public-person_roles-person_id">#</a>`person_id` | **FK [➝](#public-people-id) `people.id`**, **IDX** | `uuid`| **NO** |  | <!-- comment on column "public"."person_roles"."person_id" is @until-end-tag; --><!-- end --> |
| <a id="user-content-public-person_roles-person_id" href="#public-person_roles-person_id">#</a>**`person_id`** | **PK** | `uuid`| **NO** |  | <!-- comment on column "public"."person_roles"."person_id" is @until-end-tag; --><!-- end --> |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`13`** | count=**`127.946`** | inserted=**`127.946`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`511.784`** | rows=**`0`** | live=**`127.946`**, dead=**`0`** | last auto=**`2022-10-17 11:02:32Z`**, rows inserted since=**`0`** | last auto=**`2022-10-17 11:02:32Z`**, rows updated since=**`0`** |
...
| **Sequence Scan** | **Index Scan** | **Rows** | **Vaccum** | **Analyze** |
| ----------------- | -------------- | -------- | ---------- | ----------- |
| count=**`6`** | count=**`490.775`** | inserted=**`1`**, updated=**`0`**, deleted=**`0`** | last=, count=**`0`** | last=, count=**`0`** |
| rows=**`3`** | rows=**`490.775`** | live=**`1`**, dead=**`0`** | last auto=, rows inserted since=**`1`** | last auto=, rows updated since=**`1`** |
