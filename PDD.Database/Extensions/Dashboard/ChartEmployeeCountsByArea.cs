...
public static class PgRoutineChartEmployeeCountsByArea
{
    ...
    public static string? ChartEmployeeCountsByArea(this NpgsqlConnection connection, int? limit,
    ...
    public static async Task<string?> ChartEmployeeCountsByAreaAsync(this NpgsqlConnection connection, int? limit,
        [CallerMemberName] string memberName = "",
        [CallerFilePath] string sourceFilePath = "",
        [CallerLineNumber] int sourceLineNumber = 0)
    {
