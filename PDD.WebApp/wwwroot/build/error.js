var error = (function () {
    ...
    */
    ...
    /* App\shared\components\offcanvas.svelte generated by Svelte v3.54.0 */
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$3, 139, 12, 4234);
    			attr_dev(div, "class", "offcanvas-header");
    			add_location(div, file$3, 138, 8, 4190);
    		},
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 146, 12, 4462);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	let t1;
    	let current;
    	let if_block0 = /*promise*/ ctx[5] && create_if_block_2$1(ctx);
    	let if_block1 = /*content*/ ctx[8] && create_if_block_1$1(ctx);
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$3, 155, 24, 4781);
    			attr_dev(div, "class", "text-center");
    			add_location(div, file$3, 154, 20, 4730);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, i);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 150, 4, 4591);
    			...
    			add_location(div1, file$3, 136, 0, 3958);
    		},
    ...
    /* App\shared\layout\link-list-items.svelte generated by Svelte v3.54.0 */
    ...
    /* App\shared\layout\offcanvas-layout.svelte generated by Svelte v3.54.0 */
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 85, 25, 2439);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    // (87:4) <Offcanvas state={offcanvas} class="offcanvas-nav navbar-dark bg-primary" on:hidden={() => toggleOffcanvas(false)} use={useOffcanvas}>
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 87, 8, 2690);
    			attr_dev(ul, "class", "navbar-nav navbar-dark flex-column mt-4");
    			add_location(ul, file$1, 88, 8, 2831);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			insert_dev(target, t, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(87:4) <Offcanvas state={offcanvas} class=\\\"offcanvas-nav navbar-dark bg-primary\\\" on:hidden={() => toggleOffcanvas(false)} use={useOffcanvas}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(107:16) {#if user.isSigned}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$1, 100, 20, 3241);
    			attr_dev(span, "class", "font-monospace");
    			add_location(span, file$1, 101, 20, 3327);
    			attr_dev(button0, "class", "btn btn-primary");
    			add_location(button0, file$1, 99, 16, 3152);
    			attr_dev(div0, "class", "d-flex float-start");
    			add_location(div0, file$1, 98, 12, 3102);

    			attr_dev(i1, "class", i1_class_value = /*$isDarkTheme*/ ctx[3]
    			? "bi-lightbulb"
    			: "bi-lightbulb-off");

    			add_location(i1, file$1, 120, 20, 4320);
    ...
    /* App\error.svelte generated by Svelte v3.54.0 */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			t0 = text("Here is what we know so far: ");
    			div0 = element("div");
    			div0.textContent = `${/*error*/ ctx[0]}`;
    			attr_dev(div0, "class", "text-danger fw-bold fs-5");
    			add_location(div0, file, 16, 45, 500);
    			attr_dev(div1, "class", "mt-3");
    			add_location(div1, file, 15, 12, 435);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, t0);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			t4 = text("here");
    			t5 = text(" to return to start screen and try again.");
    			attr_dev(i, "class", "bi bi-bug-fill text-danger");
    			add_location(i, file, 11, 12, 321);
    			attr_dev(h1, "class", "text-primary");
    			add_location(h1, file, 10, 8, 282);
    			attr_dev(a, "href", urls.indexUrl);
    			add_location(a, file, 20, 18, 639);
    			attr_dev(div0, "class", "mt-5 fs-6");
    			add_location(div0, file, 19, 8, 596);
    			attr_dev(div1, "class", "container svelte-bmfybb");
    			add_location(div1, file, 9, 4, 249);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, h1);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Layout: Offcanvas_layout, errorKey, urls, error });
